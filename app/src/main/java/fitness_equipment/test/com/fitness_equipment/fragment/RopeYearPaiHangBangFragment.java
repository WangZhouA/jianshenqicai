...
import fitness_equipment.test.com.fitness_equipment.adapter.YearBangdanAdapter;
...
public class RopeYearPaiHangBangFragment extends Fragment {


    private ListView listViews;
    private YearBangdanAdapter adapter;
        ...
        public void handleMessage(Message msg) {
            switch (msg.what){
                case 0:
                    ...
                    adapter=new YearBangdanAdapter(lists,getActivity());
...
//                                dissMissMyLoadingDialogFalse();
    ...
    View view;
    DayPaiHangPang dayPaiHangPang;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {

        view = inflater.inflate(R.layout.fragment_rope_year_paihangbang, null);
        ...
        IntentFilter.addAction("YEARADD");
        getActivity().registerReceiver(broadcastReceiver,IntentFilter);

        dayPaiHangPang=new DayPaiHangPang();
        return view;
    }
    ...
    private void Query(String time ){
        ...
        final String reigstStr = StringUtils.YEAR_BANGDAN_QUERY ;
