...
public class SMSActivity extends BasActivity  implements TextWatcher {
    ...
    protected void init() {
         ...
         *  动态限制 长度为11
         * */
        smsEtPhone.setFilters(new InputFilter[]{new InputFilter.LengthFilter(11)});
        //四个监听器
        ...
        headerText.setText(R.string.Message_authentication);
        ...
        smsTextType.setText(getResources().getString(R.string.ToEmailFind));
        ...
        switch (view.getId()) {
            ...
            case R.id.sms_et_send:
                ...
                if (TureOrFalseNetwork()==true) {
                    //是否合法
                    if (isMobile(smsEtPhone.getText().toString()) == true ) {
            ...
            case R.id.sms_textType:
                Intent intent = new Intent(SMSActivity.this,EmailActivity.class);
