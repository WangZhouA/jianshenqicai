            ...
            switch (msg.what){
                case 0:
                    ...
                    new Handler().postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            LemonBubble.showRight(DaKaJiLuActivity.this, getResources().getString(R.string.trueRequset), 1000);
                            new Handler().postDelayed(new Runnable() {
                                @Override
                                public void run() {

                                    challengeAdapter=new ChallengeAdapter(listChallengeDate,DaKaJiLuActivity.this);
    ...
    private void initView() {
        ...
        SwipeMenuCreator creater = new SwipeMenuCreator() {
            ...
            public void create(SwipeMenu menu) {
                ...
                SwipeMenuItem deleteItem = new SwipeMenuItem(DaKaJiLuActivity.this);
...
//                            okHttpAddPersionToDervice(position);
        ...
        listviews.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent =new Intent(DaKaJiLuActivity.this,MotionRecordsActivity.class);
    ...
    protected void init() {
        ...
        headerText.setText(R.string.daka_record);
