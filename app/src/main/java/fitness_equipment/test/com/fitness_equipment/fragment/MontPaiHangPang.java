...
public class MontPaiHangPang  extends Fragment implements View.OnClickListener{
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_mont_paihangbang, null);
        ...
        home_bicycle = new BicycleMontPaiHangBangFragment();
        home_rope = new RopeMontPaiHangBangFragment() ;
    ...
    public class MyOnPageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int arg0) {
            ...
            switch (arg0) {
                case 0:
                    if (currIndex == 1) {
                        Intent intent =new Intent("MONTADD");
                ...
                case 1:
                    if (currIndex == 0) {
                        Intent intent1 =new Intent("MONTADD");
    ...
    private BroadcastReceiver broadcastReceiver=new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.contains("UPDATE_TIME")){
                ...
                monmentTimeTv.setText(TimeZhuanHuan(Notime));
            }
