...
public class WeekFirstFragment extends Fragment implements View.OnClickListener {
    View view;
...
//    DateFormat df = new SimpleDateFormat("yyyy-MM-dd");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        home_bicycle = new WeekBicycleFragment();
        home_rope = new WeekRopeFragment();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_tab_rope:
                ...
                Intent intent1 =new Intent("TOUPDATE");
...
//
//
//    private String addNowTime(String d) throws ParseException {
//
//        Date dd = df.parse(d);
//        Calendar calendar = Calendar.getInstance();
//        calendar.setTime(dd);
//        calendar.add(Calendar.DAY_OF_MONTH, 7);//加七天
//        return  df.format(calendar.getTime());
//    }
//
//    private  String   deleteNowTime(String d)throws ParseException {
///**
// * 减七天
// */
//
//        long dif = df.parse(d).getTime()-86400*7000;//减七天
//        Date date=new Date();
//        date.setTime(dif);
