...
public class MontRopeFragment  extends Fragment{
    ...
    private float maxY = 500f;//Y轴坐标最大值
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view=inflater.inflate(R.layout.fragment_rope_mont ,null);
    ...
    private void okHttpQueryWeekKM() {
        ...
        final String reigstStr = StringUtils.QUERY_ROPE_MONT  ;
