...
public class YearPaihang extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_year_paihangbang, null);
        ...
        home_bicycle = new BicycleYearPaiHangBangFragment();
        home_rope = new RopeYearPaiHangBangFragment() ;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_tab_bicycle:
                mPager.setCurrentItem(0);
                Intent intent =new Intent("YEARADD");
            ...
            case R.id.tv_tab_rope:
                ...
                Intent intent1 =new Intent("YEARADD");
