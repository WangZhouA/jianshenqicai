...
public class DayPaiHangPang extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_day_paihangbang, null);
        ...
        home_bicycle = new BicycleDayPaiHangbangFragment();
        home_rope = new RopeDayPaiHangBangFragment() ;
        ...
        monmentTimeTv.setText(MonmentListActivity.getNowTime());
