...
import fitness_equipment.test.com.fitness_equipment.activity.SportsTypeActivity;

/**
 * Created by 陈姣姣 on 2017/11/14.
 */

public class ActionBicycleFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.action_bicycle, null);
        ...
        public void onViewClicked(View view) {
            switch (view.getId()) {
                ...
                case R.id.start_movment:
                    ...
                    intent =new Intent(getActivity(), SportsTypeActivity.class);
                    startActivity(intent);
                    break;
            }
        }
