...
public class RopeWeekPaiHangBangFragment extends Fragment{


    private ListView listViews;
        private WeekBangdanAdapter adapter;
        ...
        public void handleMessage(Message msg) {
            switch (msg.what){
                case 0:
                    ...
                    adapter=new WeekBangdanAdapter(lists,getActivity());
...
//                                dissMissMyLoadingDialogFalse();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_week_rope_paihangbang , null);
        ...
        IntentFilter.addAction("WEEKADD");
    ...
    private void Query(String time ){
        ...
        final String reigstStr = StringUtils.WEEK_BANGDAN_QUERY ;
