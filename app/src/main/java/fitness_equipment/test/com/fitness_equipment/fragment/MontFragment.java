...
public class MontFragment extends Fragment implements View.OnClickListener {
...
//    DateFormat df = new SimpleDateFormat("yyyy-MM-dd");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.mont_fragment, null);
        MyApplication.getInstance().addActyToList(getActivity());
        unbinder = ButterKnife.bind(this, view);
        fragmentsList = new ArrayList<>();

        home_bicycle = new MontBicycleFragment();
        home_rope = new MontRopeFragment() ;
