...
public class RopeMontPaiHangBangFragment extends Fragment {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what){
                case 0:
                    ...
                    adapter=new MontBangdangAdapter(lists,getActivity());
...
//                                dissMissMyLoadingDialogFalse();
    ...
    private void Query(String time ){
        ...
        final String reigstStr = StringUtils.MONT_BANGDAN_QUERY ;
